...
import io.proximi.demo.UnitHelper
    ...
    inner class RouteStepViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        fun load(routeNode: Route.RouteNode) {
            ...
            if (routeNode.distanceFromLastNode != 0.0) {
                ...
                itemView.stepCountTextView.text = UnitHelper.distanceEstimateString(routeNode.distanceFromLastNode, itemView.context.resources)
            } else {
